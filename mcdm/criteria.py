...
POSITION_CRITERIA = {
    "Forward": {
        ...
        "Goals/xG": {"column": "goals_per_xg", "type": 1, "label": "Goals / xG<br>(Finishing)"},
        ...
        "Defensive Contribution": {"column": "defensive_contribution_per90", "type": 1, "label": "Defensive<br>Work"},
        "Aerial Ability": {"column": "clearances_blocks_interceptions_per90", "type": 1, "label": "Aerial<br>Ability"},
    },
    "Midfielder": {
    ...
    "Goalkeeper": {
        ...
        "Goals Prevented": {"column": "goals_prevented_per90", "type": 1, "label": "Goals<br>Prevented"},
        "xGC": {"column": "expected_goals_conceded_per90", "type": -1, "label": "Expected Goals<br>Conceded"},
        "Influence": {"column": "influence_per90", "type": 1, "label": "Influence"},
    },
}
...
ROLE_CRITERIA = {
    ...
    "CB": {
        "Tackles": {"column": "tackles_per90", "type": 1, "label": "Tackles"},
        "Clearances/Blocks/Int": {"column": "clearances_blocks_interceptions_per90", "type": 1, "label": "Clearances/<br>Blocks/Int"},
        "Clean Sheets": {"column": "clean_sheets_per90", "type": 1, "label": "Clean Sheets"},
    ...
    "CDM": {
        ...
        "Recoveries": {"column": "recoveries_per90", "type": 1, "label": "Recoveries"},
        "Defensive Contribution": {"column": "defensive_contribution_per90", "type": 1, "label": "Defensive<br>Work"},
        "BPS": {"column": "bps_per90", "type": 1, "label": "Bonus Point<br>Score"},
        "Influence": {"column": "influence_per90", "type": 1, "label": "Influence"},
    },
    ...
    "CM": {
        "Goals": {"column": "goals_scored_per90", "type": 1, "label": "Goals"},
        "Assists": {"column": "assists_per90", "type": 1, "label": "Assists"},
        "xGI": {"column": "expected_goal_involvements_per90", "type": 1, "label": "Expected G+A<br>(xGI)"},
        "Creativity": {"column": "creativity_per90", "type": 1, "label": "Creativity"},
        "Tackles": {"column": "tackles_per90", "type": 1, "label": "Tackles"},
        "Recoveries": {"column": "recoveries_per90", "type": 1, "label": "Recoveries"},
        "Influence": {"column": "influence_per90", "type": 1, "label": "Influence"},
    ...
    "ST": {
        ...
        "Goals/xG": {"column": "goals_per_xg", "type": 1, "label": "Goals / xG<br>(Finishing)"},
        "xGI": {"column": "expected_goal_involvements_per90", "type": 1, "label": "Expected G+A<br>(xGI)"},
        "Shooting Threat": {"column": "threat_per90", "type": 1, "label": "Shooting<br>Threat"},
        "Assists": {"column": "assists_per90", "type": 1, "label": "Assists"},
        "Aerial Ability": {"column": "clearances_blocks_interceptions_per90", "type": 1, "label": "Aerial<br>Ability"},
        "Defensive Contribution": {"column": "defensive_contribution_per90", "type": 1, "label": "Defensive<br>Work"},
    },
